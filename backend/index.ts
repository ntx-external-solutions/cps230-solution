...
import './functions/control-critical-operations';
import './functions/control-processes';
import './functions/control-systems';
import './functions/settings';
import './functions/sync-history';
import './functions/sync-process-manager';
