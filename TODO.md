...
- [x] 1. Fix: Process relationship not displaying in Critical Operations table
- [x] 2. Schema: Add many-to-many relationships for processes and systems
- [x] 3. UI: Update modal to support multi-select for processes and systems
- [x] 4. Fix: Color picker not saving/displaying correctly
- [x] 5. Verify: Apply same process/system relationship fixes to Controls
- [x] 6. Verify: Apply color picker fix to Controls
